...
4c. The system must perform pre-launch checks before the rocket is launched. These checks will occur after the system has determined that a launch can occur and the user has informed the system of their intent to launch. The pre-launch checks will include communicating with the rocket to ensure that: the system can communicate with the rocket; the rocket can receive communication from the system; the rocket can communicate with the system; the system can receive communication from the system; and all of the rocket's systems are nominal.

4d. The system must perform launch checks during the launch procedure. These checks will ensure that all of the rocket's systems remain nominal, and the rocket and system can continue to communicate with each other during the launch stage. During this stage, the system allows the user to terminate the launch, which will halt the launch checks.
